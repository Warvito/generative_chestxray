""" Script to generate sample images from the diffusion model for the FID vs CLIP curve.

Different from the sample_images.py, this script will generate images using 1000 text prompts sampled from the
test set.
"""
