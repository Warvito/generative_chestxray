...
def parse_args():
    ...
    parser.add_argument("--start_seed", help="Path to the MLFlow artifact of the stage1.")
    parser.add_argument("--stop_seed", help="Path to the MLFlow artifact of the stage1.")
