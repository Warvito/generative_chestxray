""" Based on https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iv-cxr/txt/create_section_files.py """
import argparse
import csv
import os
import re
...
def list_rindex(analised_list, s):
    """Helper function: *last* matching element in a list"""
    return len(analised_list) - analised_list[-1::-1].index(s) - 1
